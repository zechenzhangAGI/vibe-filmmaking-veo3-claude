    ...
    def generate_clip(
        ...
        try:
            ...
            if extend_from_clip:
                ...
                print(f"📤 Video loaded for extension")
...
def main():
    ...
    # Define clip generation sequence - V5 FINAL: Pencil Sketch Style with Motion
    clips = [
        # Clip 1: Galileo (Independent) - 1080p/8s
        {
